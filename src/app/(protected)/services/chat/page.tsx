      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Your intelligent legal assistant powered by AI. Ask questions about
            Indian law, contracts, compliance, and get expert guidance
            instantly.
          </p>
        </div>
        ...
        <div className="mb-12">
          <Card className="p-6 bg-background/80 backdrop-blur-sm border-border/50">
            ...
            <p className="text-sm text-muted-foreground mt-4">
              ...
              provides general legal information, not professional legal advice.
            </p>
          </Card>
        </div>
