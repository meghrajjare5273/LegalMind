          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-white/80 leading-relaxed">
                Start your journey with intelligent legal assistance that adapts
                to your needs and grows with your practice.
              </p>
            </div>

            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-[#DAF6F5]">
                What you&apos;ll get:
              </h3>
              {[
                "Instant contract analysis and risk assessment",
                "AI-powered legal research and case precedents",
                "24/7 access to legal guidance and consultation",
                "Secure document processing and storage",
                "Personalized legal insights and recommendations",
              ].map((feature, index) => (
                <motion.div
                  key={feature}
                ...
                >
                  <CheckCircle className="w-5 h-5 text-[#DAF6F5] mt-0.5 flex-shrink-0" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start space-x-3">
                <input
                  ...
                  className="w-4 h-4 mt-1 rounded border-white/20 bg-white/10 text-[#DAF6F5] focus:ring-[#DAF6F5]/20"
                  required
                />
                <label
                  htmlFor="terms"
                ...
                >
                  ...
                  <Link
                    href="/terms"
                    className="text-[#DAF6F5] hover:text-white transition-colors"
                  >
                    Terms & Conditions
                  </Link>{" "}
                  and{" "}
